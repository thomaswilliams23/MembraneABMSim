...
"""
    @kernel function compute_next_positions_CUDA!(
        positions::CuDeviceVector{Float32, CUDA.DeviceMemory},
        next_positions::CuDeviceVector{Float32, CUDA.DeviceMemory},
        effective_radii::CuDeviceVector{Float32, CUDA.DeviceMemory},
        identifiers::CuDeviceVector{Int, CUDA.DeviceMemory},
        tether_points::CuDeviceVector{Float32, CUDA.DeviceMemory},
        agg_dist_since_grid_sync::CuDeviceVector{Float32, CUDA.DeviceMemory},
        nascent_to_inserting_ixs::CuDeviceVector{Int, CUDA.DeviceMemory},
        nascent_to_substrate_ixs::CuDeviceVector{Int, CUDA.DeviceMemory},
        substrate_inserting_ideal_dists::CuDeviceVector{Float32, CUDA.DeviceMemory},
        coords_to_z_ix::CuDeviceVector{Int, CUDA.DeviceMemory},
        z_ix_to_coords::CuDeviceVector{Int, CUDA.DeviceMemory},
        agent_cell_z_ixs::CuDeviceVector{Int, CUDA.DeviceMemory},
        num_agents_in_cell::CuDeviceVector{Int, CUDA.DeviceMemory},
        start_agents_in_cell::CuDeviceVector{Int, CUDA.DeviceMemory},
