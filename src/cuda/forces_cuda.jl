...
"""
    @kernel function compute_next_positions_CUDA!(
        ...
        agg_dist_since_grid_sync::CuDeviceVector{Float32, 1, CUDA.DeviceMemory},
        nascent_to_inserting_ixs::CuDeviceVector{Int, 1, CUDA.DeviceMemory},
        nascent_to_substrate_ixs::CuDeviceVector{Int, 1, CUDA.DeviceMemory},
        substrate_inserting_ideal_dists::CuDeviceVector{Float32, 1, CUDA.DeviceMemory},
        coords_to_z_ix::CuDeviceVector{Int, 1, CUDA.DeviceMemory},
        z_ix_to_coords::CuDeviceVector{Int, 1, CUDA.DeviceMemory},
        agent_cell_z_ixs::CuDeviceVector{Int, 1, CUDA.DeviceMemory},
        num_agents_in_cell::CuDeviceVector{Int, 1, CUDA.DeviceMemory},
        start_agents_in_cell::CuDeviceVector{Int, 1, CUDA.DeviceMemory},
