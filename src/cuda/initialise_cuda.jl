...
"""
    run_equilibration_CUDA!(agents::AllAgents, grid_size::GridSize, grid::Grid, system_flat_cpu::SystemFlatCPU, all_data_CUDA::AllDataCUDA, grid_size_CUDA::GridSizeCUDA, force_kernel, params::AllParams, equilibration_time::Float64; suppress_prints::Bool=false)
...
"""
function run_equilibration_CUDA!(agents::AllAgents, grid_size::GridSize, grid::Grid, system_flat_cpu::SystemFlatCPU, all_data_CUDA::AllDataCUDA, grid_size_CUDA::GridSizeCUDA, force_kernel, params::AllParams, equilibration_time::Float64; suppress_prints::Bool=false)
...
"""
    run_membrane_shrinkage_CUDA!(agents::AllAgents, grid_size::GridSize, grid::Grid, system_flat_cpu::SystemFlatCPU, all_data_CUDA::AllDataCUDA, grid_size_CUDA::GridSizeCUDA, force_kernel, params::AllParams; suppress_prints::Bool=false)
...
"""
function run_membrane_shrinkage_CUDA!(agents::AllAgents, grid_size::GridSize, grid::Grid, system_flat_cpu::SystemFlatCPU, all_data_CUDA::AllDataCUDA, grid_size_CUDA::GridSizeCUDA, force_kernel, params::AllParams; suppress_prints::Bool=false)
